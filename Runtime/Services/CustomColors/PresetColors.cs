...
namespace Packages.com.ianritter.unityscriptingtools.Runtime.Services.CustomColors
{
    public static class PresetColors
    {
        ...
        public static CustomColor DarkSlateGray = new CustomColor( nameof( DarkSlateGray ), new Color( 0.18f, 0.31f, 0.31f) );
        ...
        // Reds
        public static CustomColor IndianRed = new CustomColor( nameof( IndianRed ), new Color(0.80f, 0.36f, 0.36f) );
        ...
        public static CustomColor Crimson = new CustomColor( nameof( Crimson ), new Color(0.86f, 0.08f, 0.24f) );
        public static CustomColor Red = new CustomColor( nameof( Red ), new Color(1.00f, 0.00f, 0.00f) );
        public static CustomColor FireBrick = new CustomColor( nameof( FireBrick ), new Color(0.70f, 0.13f, 0.13f) );
        ...
        public static CustomColor DeepPink = new CustomColor( nameof( DeepPink ), new Color(1.00f, 0.08f, 0.58f) );
        public static CustomColor MediumVioletRed = new CustomColor( nameof( MediumVioletRed ), new Color(0.78f, 0.08f, 0.52f) );
        public static CustomColor PaleVioletRed = new CustomColor( nameof( PaleVioletRed ), new Color(0.86f, 0.44f, 0.58f) );

        // Oranges
        public static CustomColor Coral = new CustomColor( nameof( Coral ), new Color(1.00f, 0.50f, 0.31f) );
        public static CustomColor Tomato = new CustomColor( nameof( Tomato ), new Color(1.00f, 0.39f, 0.28f) );
        public static CustomColor OrangeRed = new CustomColor( nameof( OrangeRed ), new Color(1.00f, 0.27f, 0.00f) );
        ...
        public static CustomColor MediumOrchid = new CustomColor( nameof( MediumOrchid ), new Color( 0.73f, 0.33f, 0.83f) );
        public static CustomColor MediumPurple = new CustomColor( nameof( MediumPurple ), new Color( 0.58f, 0.44f, 0.86f) );
        public static CustomColor RebeccaPurple = new CustomColor( nameof( RebeccaPurple ), new Color( 0.40f, 0.20f, 0.60f) );
        public static CustomColor BlueViolet = new CustomColor( nameof( BlueViolet ), new Color( 0.54f, 0.17f, 0.89f) );
        public static CustomColor DarkViolet = new CustomColor( nameof( DarkViolet ), new Color( 0.58f, 0.00f, 0.83f) );
        public static CustomColor DarkOrchid = new CustomColor( nameof( DarkOrchid ), new Color( 0.60f, 0.20f, 0.80f) );
        ...
        public static CustomColor Indigo = new CustomColor( nameof( Indigo ), new Color( 0.29f, 0.00f, 0.51f) );
        public static CustomColor SlateBlue = new CustomColor( nameof( SlateBlue ), new Color( 0.42f, 0.35f, 0.80f) );
        public static CustomColor DarkSlateBlue = new CustomColor( nameof( DarkSlateBlue ), new Color( 0.28f, 0.24f, 0.55f) );

        // Greens
        public static CustomColor GreenYellow = new CustomColor( nameof( GreenYellow ), new Color( 0.68f, 1.00f, 0.18f) );
        ...
        public static CustomColor LimeGreen = new CustomColor( nameof( LimeGreen ), new Color( 0.20f, 0.80f, 0.20f) );
        ...
        public static CustomColor MediumSeaGreen = new CustomColor( nameof( MediumSeaGreen ), new Color( 0.24f, 0.70f, 0.44f) );
        public static CustomColor SeaGreen = new CustomColor( nameof( SeaGreen ), new Color( 0.18f, 0.55f, 0.34f) );
        public static CustomColor ForestGreen = new CustomColor( nameof( ForestGreen ), new Color( 0.13f, 0.55f, 0.13f) );
        ...
        public static CustomColor YellowGreen = new CustomColor( nameof( YellowGreen ), new Color( 0.60f, 0.80f, 0.20f) );
        public static CustomColor OliveDrab = new CustomColor( nameof( OliveDrab ), new Color( 0.42f, 0.56f, 0.14f) );
        public static CustomColor Olive = new CustomColor( nameof( Olive ), new Color( 0.50f, 0.50f, 0.00f) );
        public static CustomColor DarkOliveGreen = new CustomColor( nameof( DarkOliveGreen ), new Color( 0.33f, 0.42f, 0.18f) );
        ...
        public static CustomColor LightSeaGreen = new CustomColor( nameof( LightSeaGreen ), new Color( 0.13f, 0.70f, 0.67f) );
        ...
        public static CustomColor Turquoise = new CustomColor( nameof( Turquoise ), new Color( 0.25f, 0.88f, 0.82f ) );
        public static CustomColor MediumTurquoise = new CustomColor( nameof( MediumTurquoise ), new Color( 0.28f, 0.82f, 0.80f ) );
        public static CustomColor DarkTurquoise = new CustomColor( nameof( DarkTurquoise ), new Color( 0.00f, 0.81f, 0.82f ) );
        public static CustomColor CadetBlue = new CustomColor( nameof( CadetBlue ), new Color( 0.37f, 0.62f, 0.63f ) );
        public static CustomColor SteelBlue = new CustomColor( nameof( SteelBlue ), new Color( 0.27f, 0.51f, 0.71f ) );
        ...
        public static CustomColor DodgerBlue = new CustomColor( nameof( DodgerBlue ), new Color( 0.12f, 0.56f, 1.00f ) );
        ...
        public static CustomColor RoyalBlue = new CustomColor( nameof( RoyalBlue ), new Color( 0.25f, 0.41f, 0.88f ) );
        ...
        public static CustomColor MidnightBlue = new CustomColor( nameof( MidnightBlue ), new Color( 0.10f, 0.10f, 0.44f ) );
        ...
        public static CustomColor SandyBrown = new CustomColor( nameof( SandyBrown ), new Color( 0.96f, 0.64f, 0.38f) );
        public static CustomColor Goldenrod = new CustomColor( nameof( Goldenrod ), new Color( 0.85f, 0.65f, 0.13f) );
        public static CustomColor DarkGoldenrod = new CustomColor( nameof( DarkGoldenrod ), new Color( 0.72f, 0.53f, 0.04f) );
        public static CustomColor Peru = new CustomColor( nameof( Peru ), new Color( 0.80f, 0.52f, 0.25f) );
        public static CustomColor Chocolate = new CustomColor( nameof( Chocolate ), new Color( 0.82f, 0.41f, 0.12f) );
        public static CustomColor SaddleBrown = new CustomColor( nameof( SaddleBrown ), new Color( 0.55f, 0.27f, 0.07f) );
        public static CustomColor Sienna = new CustomColor( nameof( Sienna ), new Color( 0.63f, 0.32f, 0.18f) );
        public static CustomColor Brown = new CustomColor( nameof( Brown ), new Color( 0.65f, 0.16f, 0.16f) );
