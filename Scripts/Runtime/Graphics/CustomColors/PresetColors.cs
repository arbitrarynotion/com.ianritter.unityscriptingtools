...
namespace Packages.com.ianritter.unityscriptingtools.Scripts.Runtime.Graphics.CustomColors
{
    public static class PresetColors
    {
        ...
        /// </summary>
        private static IEnumerable<FieldInfo> GetAllFields( Type type ) => type.GetNestedTypes().SelectMany( GetAllFields ).Concat( type.GetFields() );

        private static Color GetConvertedColor( int r, int g, int b ) =>
            new Color(
