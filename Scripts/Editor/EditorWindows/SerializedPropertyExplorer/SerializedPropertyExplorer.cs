...
using static Packages.com.ianritter.unityscriptingtools.Scripts.Editor.EditorWindows.SerializedPropertyExplorer.SerializedPropertyInfoExtractor;
...
{
    public class SerializedPropertyExplorer : UnityEditor.EditorWindow
    {
