using Packages.com.ianritter.unityscriptingtools.Scripts.Editor.Tools.ColorEntryHelperWindow;
using UnityEditor;
using UnityEngine;
using static Packages.com.ianritter.unityscriptingtools.Scripts.Runtime.Graphics.UI.TextFormatting;

namespace Packages.com.ianritter.unityscriptingtools.Scripts.Editor.Tools.CustomColorPicker.CustomColors
{
