...
namespace Packages.com.ianritter.unityscriptingtools.Scripts.Editor.Services
{
    ...
    {
        public static T GetAssetByName<T>( string assetName ) => GetAssetByName<T>( assetName, null );
        ...
        {
            FormattedLogger asset = LoadAssetToPropertyByNameWithDefault( targetAssetName, defaultAssetName, defaultAssetSearchPath );
        ...
        public static FormattedLogger LoadAssetToPropertyByNameWithDefault( string targetAssetName, string defaultAssetName, string defaultAssetSearchPath )
        {
            ...
            var asset = GetAssetByName<FormattedLogger>( targetAssetName );
            ...
            asset = GetAssetByName<FormattedLogger>( defaultAssetName, defaultAssetSearchPath );
            if( asset == null ) Debug.LogError( $"Failed to load default asset: {defaultAssetName}!" );
